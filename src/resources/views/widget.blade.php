<div class="">
    <a href="{{route('laravel-blog.show', ['id'=>$blog->id, 'slug'=>$blog->slug])}}">
        <div class="bg-slate-100 mb-6 relative h-48 w-full block bg-cover bg-center"
        ...
        <div class="">
            <h2 class="font-libre min-h-12 font-medium tracking-tight py-1">{{$blog->title}}</h2>
            <div class="py-2 h-32">{!! $blog->excerpt !!}</div>
